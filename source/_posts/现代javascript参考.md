...
文档翻译自: [Modern JavaScript Cheatsheet](https://github.com/mbeaudru/modern-js-cheatsheet)
...
愚人码头注：变量提升和函数声明提升可以查看：[JavaScript 中的 Hoisting (变量提升和函数声明提升)](http://www.css88.com/archives/7924)
...
现在，我们来看看 *let*（和 *const*）变量在被赋值之前不可访问是什么意思：
...
```
 ...
 但这里有一个小细节：`const` 变量并不是不可变，具体来说，如果 `const` 声明的变量是 *object* 和 *array* 类型的值，那它是 **可变的** 。
...
```js
function myFunc() {
  for (var i = 0; i  acc + curr, 0) / grades.length; // 根据 grade 计算平均成绩
...
模板标签是*可以作为模板字符串(template literal)的前缀函数*。当一个函数被这钟方式调用时，第一个参数是出现在模板插值变量之间的字符串数组，并且随后的参数是插值变量的值。可以使用展开运算符 `...` 捕获所有这些参数。  [(参考: MDN)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Template_literals#Tagged_template_literals)。
...
原项目：[Modern JavaScript Cheatsheet](https://github.com/mbeaudru/modern-js-cheatsheet)

## 推荐阅读最新关于 ECMAScript 的文章

- [ECMAScript 2015（ES6）的十大特征](http://www.css88.com/archives/6200)
- [JavaScript ES6（ES2015）入门-核心特性概述](http://www.css88.com/archives/6533)
- [ES6 新特性范例大全](http://www.css88.com/archives/7240)
- [现在就可以使用的5个 ES6 特性](http://www.css88.com/archives/7291)
- [面向对象的 JavaScript – 深入了解 ES6 类](http://www.css88.com/archives/7383)
- [使用 ES2017 中的 Async(异步) 函数 和 Await(等待)](http://www.css88.com/archives/7980)
- [JavaScript ECMAScript 2015 (ES6) 和 ECMAScript 2016 (ES7) 新特性速查表](http://www.css88.com/archives/8189)
- [ECMAScript 6 Modules(模块)系统及语法详解](http://www.css88.com/archives/6974)
- [学习 ES2015 新特性](http://www.css88.com/archives/6963)
- [JavaScript ES2015 中对象继承的模式](http://www.css88.com/archives/7395)
- [JavaScript 新书：探索 ES2016 与 ES2017](http://www.css88.com/archives/7753)(包含了ES2016 与 ES2017 的最新特性)